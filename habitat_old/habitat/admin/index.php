...
<table align="center" border="0" cellpadding='1' cellspacing='1' width='95%'>
	...
	<?php 
	$tampil=mysql_query("select * from t_member where username !='admin'"); // query untuk menampilkan isi data=
	$bgcolor='#fff';
...
<table align="center">
	...
	<tr>
		<td>Level</td><td><select name='cb' ><option value='0'>Jury</option><option value='1'>Facilitator</option></select></td>
	</tr>
	<tr>
...
<table align="center">
	...
	<tr>
		...
		<?php
				$level =  $data->level;
				if($level=='1'){
					$lv = "<option value='1'>Facilitator</option><option value='0'>Jury</option>";
				}else{
					$lv = "<option value='0'>Jury</option><option value='1'>Facilitator</option>";
				}
				echo $lv;			
		?>
		</select>
