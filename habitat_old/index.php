...
<body>
	<?php
		...
		if (isset($_POST['submit_add'])) {
			...
			$tgl = date("Y-m-d");
			$que = "insert into pertanyaan (nama,direktorat,pembawa,komentar, status, tanggal, id_user,vote, level) VALUES ('$Nama','$Direktorat','$Pembawa','$Komentar','0','$tgl','$idu','0','$level' )";
			$ins = mysql_query($que);
			if ($ins) {
				?>
					<div class="alert">
...
?>
	...
	<div class="question">
		<header>
			<div id="logo">
				<img src="img/pu.png" style='width:55%;'>
			</div>				
			<div id="logo2">
		...
		<div id='translt1'>
			...
			<font style='font-family: arial;font-size: 28px;color: #006699;font-weight: bold;'>Kemitraan Agenda Habitat Indonesia</font><br>
			<font style='font-family: arial;font-size: 15px;color: #006699;text-shadow: 1px 1px 1px #000000;font-weight: bold;'>Jakarta, 20 Juni 2014</font>
		</div><br> <br> <br> 
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"> 
			...
			<br><img src='img/logock.png' style='height: 35px;vertical-align: middle;'><img src='img/index.jpg' style='height: 35px;vertical-align: middle;'>
			<?php
