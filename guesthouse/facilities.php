...
background: #000;margin-bottom: 5px;">
		 <p style=" font-family:channels;letter-spacing: 1px;color:#000;"><b >MOEDJITO</b> ROOMS</p>
	...
	<!-- slider close -->
			...
			<div class="row">
				...
				<br>
				<div class='span12'>
				<div id='sub1' ><p style="font-family: anton;font-size: 80px;line-height: 85px;color: #000;/* font-weight: bolder; */letter-spacing: 5px;margin-top: 10%;">THE FAMOUS 8. <BR>DISCOVER.</p></div>
