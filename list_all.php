				...
				<div class="top-header">
					...
					<div class="top-nav">
						<ul>
							...
							<li class="active"><a href="list_all.php" class="scroll">List All Chosen</a></li>
		...
		<div class="content">
			<div class="recent-posts" id="blog">
				...
				<div class="recent-posts-head">
					<div class="contatct-form2"><input type="submit" value="Get Comment" name='submit_add' onclick="display();"/></div>
				</div>
