...
<head>
	...
	<style>
		body{
			...
			font-family: calibri,helvetica,helvetica neue,segoe ui,sans-serif;
			color:#555;
			font-size: 18px;
	...
	<?php
		...
		if (isset($_POST['submit_add'])) {
			if ($_POST['captcha'] == $_SESSION['captcha']) {
				...
				$tgl = date("Y-m-d");
				$que = "insert into pertanyaan (nama,direktorat,pembawa,komentar, status,tanggal) VALUES ('$Nama','$Direktorat','$Pembawa','$Komentar','0','$tgl')";
				$ins = mysql_query($que);
				if ($ins) {
					?>
				...
				echo 'Kode yang anda masukkan salah<br><p><a href="">Klik untuk mengirim komentar lainnya</a></p>';
			}
		} else {
...
?>
	...
	<div class="question">
		<header>
			<div id="logo">
				<img src="img/indonesia_water_week_logo.png" height=70>
				<img src="img/logo_login2.png" height=70 id="cklogo">
			</div>
			<h1 id="form_komen">Form <strong>Komentar</strong></h1>
			<div id="logo2">
				<img src="img/logo_login2.png" height=70>
			</div>
		</header>
		<div id='translt'>
