        ...
        <div class="right col">
			...
			<table width="500" border="0">
              ...
              <tr>
                ...
                <td>:</td>
                <td>
					<input type="radio" name="status" value="4" required>Lokasi Kegiatan<br>
					<input type="radio" name="status" value="1" required>Tidak Termasuk<br>
				</td>
              </tr>
              <tr>
                <td></td>
			...
			<?php
					...
					$qinput = "INSERT INTO pisew_desa (propinsi, kab_kota, kecamatan, desa, kegiatan, status,tahun) VALUES ('$propnew', '$kota', '$kecamatan', '$desa', '$kegiatan', '$status','$tahun');";
					pg_query($qinput);
					//echo $qinput;
					...
					$charini = 	array("+");
					$propnew = str_replace($charini, " ",$propinsi);
					$qedit = "UPDATE pisew_desa SET propinsi='$propnew', kab_kota='$kota', kecamatan='$kecamatan', desa='$desa', kegiatan='$kegiatan', status='$status' ,tahun='$tahun' WHERE pisew_desa_pk='$id'";
					pg_query($qedit);
					//echo $qedit;
					echo "<div class=\"success\">";
					...
					$query = "select * from pisew_desa where pisew_desa_pk = '$id_delete'";
					...
					$sql2 = "DELETE FROM pisew_desa where pisew_desa_pk = '$id_delete'";
					pg_query($sql2);
				}else if(isset($_GET['id_edit'])){		//form edit data
					$id_edit = $_GET['id_edit'];
					$qedit = "select * from pisew_desa where pisew_desa_pk = '$id_edit'";
						...
						?>
							...
							<tr>
								...
								<td>
									<?php
									if ($status == 4){
										echo '<input type="radio" name="status" value="4" required checked="checked">Lokasi Kegiatan<br>
											  <input type="radio" name="status" value="1" required>Tidak Termasuk<br>';
									}else{
										echo '<input type="radio" name="status" value="4" required >Lokasi Kegiatan<br>
											  <input type="radio" name="status" value="1" required checked="checked">Tidak Termasuk<br>';
									}
									?>
								</td>
							</tr>
			...
			$sqlview = "SELECT * FROM pisew_desa ORDER BY pisew_desa_pk DESC";
			...
			if ($tcount == 0) {
				...
				echo "<tr style='font-size:11px;'>";
					...
					echo "<td>$status</td>";
					echo "<td align=\"center\"><a href=pisew_desa.php?id_edit=$rowview[pisew_desa_pk]>Edit</a> | <a href=\"pisew_desa.php?id_delete=$rowview[pisew_desa_pk]\" onclick='return confirmDelete();'>Delete</a></td>";
				echo "</tr>";
				$i++;
				$count++;
				}
