    ...
    <body background="img/bg.png">
        ...
        <div class="right col">
			...
			<?php
					...
					$qinput = "INSERT INTO desa_pnpm (propinsi, kab_kota, kecamatan, desa, tahun, prosentase) VALUES ('$propnew', '$kota', '$kecamatan', '$desa', '$tahun', '$prosentase');";
					pg_query($qinput);
					//echo $qinput;
					...
					$charini = 	array("+");
					$propnew = str_replace($charini, " ",$propinsi);
					$qedit = "UPDATE desa_pnpm SET propinsi='$propnew', kab_kota='$kota', kecamatan='$kecamatan', desa='$desa', tahun='$tahun', prosentase='$prosentase' WHERE desa_pnpm_2011_pk='$id'";
					pg_query($qedit);
					//echo $qedit;
					echo "<div class=\"success\">";
					...
					$query = "select * from desa_pnpm where desa_pnpm_2011_pk = '$id_delete'";
					...
					$sql2 = "DELETE FROM desa_pnpm where desa_pnpm_2011_pk = '$id_delete'";
					pg_query($sql2);
				}else if(isset($_GET['id_edit'])){		//form edit data
					$id_edit = $_GET['id_edit'];
					$qedit = "select * from desa_pnpm where desa_pnpm_2011_pk = '$id_edit'";
			...
			$sqlview = "SELECT * FROM desa_pnpm ORDER BY desa_pnpm_2011_pk DESC";
			...
			if ($tcount == 0) {
				...
				echo "<tr style='font-size:13px;'>";
					...
					echo "<td>$rowview[prosentase]</td>";
					echo "<td align=\"center\"><a href=desa_pnpm.php?id_edit=$rowview[desa_pnpm_2011_pk]>Edit</a> | <a href=\"desa_pnpm.php?id_delete=$rowview[desa_pnpm_2011_pk]\" onclick='return confirmDelete();'>Delete</a></td>";
				echo "</tr>";
				$i++;
				$count++;
				}
			...
			?>
			<!-- view end -->
				<div id='logout' style='position: absolute;bottom: 0px;'><a href='logout.php'><button >Logout</button></a></div>
            </div>
