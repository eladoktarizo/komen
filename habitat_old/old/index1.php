			...
			if ($ins) {
				?>
					<div class="alert">
						...
						<p><a href="index1.php">Click here to send other comments</a></p>
					</div>
				<?
			} else {
				?>
					<div class="alert">
						...
						<p><a href="index1.php">try again</a></p>
					</div>
				<?
			}
		} else {		 
?>
	...
	<div class="question">
		<header>
			...
			<h1 id="form_komen">Discussion <strong>Summary</strong></h1>
			<div id="logo2">
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"> 
			...
			<div class="input">
 			...
 			<div class="pkomentar input">
				<label for="komentar" id="lblkomentar">Summary :</label>
				<div>
					<textarea rows="1" name="Komentar" id="Komentar"></textarea>
				</div>
			</div>
			<div class="input">
				<br><input type="submit" value="Submit" id="kirim" name='submit_add'/>
			</div>
		</form>
			<br><a href="logout.php"><button id="kirim" name="out"/>Logout</button></a> <a href="index.php"><button id="kirim" name="out"/>Home</button></a>
			<?php
