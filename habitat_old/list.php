		...
		<div class="header" id="home">
			<div class="wrap">
				<div class="top-header">
					...
					<div class="top-nav">
						<ul>
							<li><a href="post.php" class="scroll">List New</a></li>
							<li class="active"><a href="list.php" class="scroll">List Chosen</a></li>
							<li><a href="list_all.php" class="scroll">List All Chosen</a></li>
		...
		<div class="content">
			<div class="recent-posts" id="blog">
				...
				<div class="recent-posts-head">
					<div class="contatct-form2"><input type="submit" value="Get Accepted Comment" name='submit_add' onclick="display();"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Get Ignored Comment" name='submit_add' onclick="display1();"/></div>
				</div>
