...
background: #000;margin-bottom: 5px;">
		 <p style=" font-family:channels;letter-spacing: 1px;color:#000;"><b >ABOUT THE</b> MOEDJITO</p>
	...
	<!-- slider close -->
			...
			<div class="row">
				...
				<div id='sub1' ><p style="font-family: anton;font-size: 80px;line-height: 85px;color: #000;/* font-weight: bolder; */letter-spacing: 5px;margin-top: 10%;">MOEDJITO HISTORY. <BR>A SHORT RECAP.</p</div>
...
<br>
				...
				<div id='sub3' style='width:75%;margin-top: 3%;'><P style="font-family: futura;font-size: 16px;color: #5A5A5A;letter-spacing: 1px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse vestibulum tincidunt ante mollis ornare. Nulla id
