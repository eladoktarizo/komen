jQuery(document).ready(function() {
	...
	jQuery('.pic_slider').stop().animate({opacity: 1}, 100);
	$('.callbacks_nav.next').fadeIn(500);
	$('.callbacks_nav.prev').fadeIn(500)
	console.log("hover");
	}, function() {
	console.log("gone");
	jQuery('.pic_slider').stop().animate({opacity: 1}, 100);
	$('.callbacks_nav.next').fadeOut(500);
	$('.callbacks_nav.prev').fadeOut(500)
