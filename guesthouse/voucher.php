...
background: #000;margin-bottom: 5px;">
		 <p style=" font-family:channels;letter-spacing: 1px;color:#000;"><b >VOUCHER</b></p>
...
<br>
				...
				<div id='sub3' style='width:75%;'><P style="font-family: futura;font-size: 16px; margin-top:3%;color: #5A5A5A;letter-spacing: 1px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse vestibulum tincidunt ante mollis ornare. Nulla id
