		...
		<div class="header" id="home">
			<div class="wrap">
				<div class="top-header">
					...
					<div class="top-nav">
						<ul>
							<li><a href="post.php" class="scroll">List Komentar</a></li>
							<li class="active"><a href="list.php" class="scroll">List Penilaian</a></li>
		...
		<div class="content">
			<div class="recent-posts" id="blog">
				...
				<div class="recent-posts-head">
					<h3><font color="#3b3737">List Penilaian Komentar</font></h3>
