...
<?php
					...
					//	$res = mysql_query($update);
						...
						echo "<li><i class='icon-comment-alt'></i> <font color='#5182CC'>$nama </font><br><p style='margin-left:20px;'><font color='#5182CC'>Presenter: $pembawa </font></p><p style='margin-left:20px;'>$komentar</p></li>";
