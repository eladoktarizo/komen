      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="index.php?q=logopu"><span class='glyphicon glyphicon-list'></span>  List Logo Event</a></li>
            <li><a href="index.php?q=add_logo"><span class='glyphicon glyphicon-plus'></span>  Tambah Logo Event</a></li>

			<li class="active"><a href="#"><span class='glyphicon glyphicon-picture'></span>  Background</a></li>
            <li><a href="index.php?q=bg"><span class='glyphicon glyphicon-list'></span>  List Background</a></li>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
             <li class="active"><a href="#"><span class='glyphicon glyphicon-picture'></span>  Logo</a></li>
            <li><a href="index.php?q=logo"><span class='glyphicon glyphicon-list'></span>  List Logo Event</a></li>
            <li><a href="index.php?q=logopu"><span class='glyphicon glyphicon-list'></span>  Logo PU Ciptakarya</a></li>
            <li><a href="index.php?q=add_logo"><span class='glyphicon glyphicon-plus'></span>  Tambah Logo Event</a></li>
          </ul>
          <ul class="nav nav-sidebar">
             <li class="active"><a href="#"><span class='glyphicon glyphicon-picture'></span>  Background</a></li>
