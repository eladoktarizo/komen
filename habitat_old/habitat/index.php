...
?>
	...
	<div class="question">
		...
		<div id='translt1'>
			...
			<font style='font-family: arial;font-size: 17px;color: #006699;font-weight: bold;'>Kemitraan Agenda Habitat Indonesia</font><br>
		...
		<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post"> 
			...
			<br><img src='img/logock.png' style='height: 60px;vertical-align: middle;'><img src='img/index.jpg' style='height: 60px;vertical-align: middle;'>
			<?php
