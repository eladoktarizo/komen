	...
	<head>
		...
		<script type="text/javascript">
			...
			function gow(id){
				var idna = id;
				//console.log(idna);
					$.post( "accept.php",{id:idna,val:"1"}, function( data ) {
					 // $( ".slide" ).html( data );
					 $( "#"+idna+"" ).remove();
					});
			}
			function abaikan(id){
				var idna = id;
				//console.log(idna);
					$.post( "accept.php",{id:idna,val:"2"}, function( data ) {
					 // $( ".slide" ).html( data );
					 $( "#"+idna+"" ).remove();
					});
			}
	...
	<body>
		<div class="header" id="home">
			<div class="wrap">
				<div class="top-header">
					...
					<div class="top-nav">
						<ul>
							<li class="active"><a href="post.php" class="scroll">List New</a></li>
							<li><a href="list.php" class="scroll">List Chosen</a></li>
		...
		<div class="content">
			<div class="recent-posts" id="blog">
				<div class="wrap"> <? //echo date("Y-m-d"); ?>
