    ...
    <body background="img/bg.png">
        ...
        <div class="right col">
			...
			<?php
					...
					$qinput = "INSERT INTO desapotensial (propinsi, kab_kota, kecamatan, desa, tahun, jumlah, status) VALUES ('$propnew', '$kota', '$kecamatan', '$desa', '$tahun', '$jumlah', '$status');";
					pg_query($qinput);
					//echo $qinput;
					...
					$charini = 	array("+");
					$propnew = str_replace($charini, " ",$propinsi);
					$qedit = "UPDATE desapotensial SET propinsi='$propnew', kab_kota='$kota', kecamatan='$kecamatan', desa='$desa', tahun='$tahun', jumlah='$jumlah' WHERE desapotensial_pk='$id'";
					pg_query($qedit);
					//echo $qedit;
					echo "<div class=\"success\">";
					...
					$query = "select * from desapotensial where desapotensial_pk = '$id_delete'";
					...
					$sql2 = "DELETE FROM desapotensial where desapotensial_pk = '$id_delete'";
					pg_query($sql2);
				}else if(isset($_GET['id_edit'])){		//form edit data
					$id_edit = $_GET['id_edit'];
					$qedit = "select * from desapotensial where desapotensial_pk = '$id_edit'";
			...
			$sqlview = "SELECT * FROM desapotensial ORDER BY desapotensial_pk DESC";
			...
			if ($tcount == 0) {
				...
				echo "<tr style='font-size:13px;'>";
					...
					echo "<td align=\"center\"><a href=desapotensial.php?id_edit=$rowview[desapotensial_pk]>Edit</a> | <a href=\"desapotensial.php?id_delete=$rowview[desapotensial_pk]\" onclick='return confirmDelete();'>Delete</a></td>";
				echo "</tr>";
				$i++;
				$count++;
				}
