	...
	<html lang="en">
		<head>
			...
			<style>
				...
				line-height: 30px;
				font-family: channels,verdana,arial;
				font-size: 30px;
				color: #000;
				font-weight: bold;
	...
	<body>
		<?php
			...
			if (isset($_POST['submit_add'])) {
				...
				if ($ins) {
					?>
						<div class="alert">
							<p>Komentar Sudah Tersampaikan, Terima Kasih</p>
							<p><a href="index.php">Klik disini untuk mengirim komentar lainnya</a></p>
						</div>
					<?php
				} else {
					?>
						<div class="alert">
							<p>Komentar tidak Terkirim</p>
							<p><a href="index.php">Coba Kembali</a></p>
						</div>
					<?php
				}
			} else {		 
		...
		<div class="question">
			<header style="display:inline-block;width:100%;">
				...
				<!-- buka comment -->
				<!-- <div id="logo" style="width:70%;float:left;position:relative;display:inline-block;margin:0px;padding:0px;"> -->
					<!-- <?php echo $logona;?>  -->
					<!--img style="width: 10%; position: relative; float:right;" src="img/logock.png"-->
				<!-- </div>	

							-->
				<div id="logo2"style="width:30%;float:left;position:relative;display:inline-block;margin:0px;padding:0px;">
					<!--img src="img/logo_login2.png" height='65' style='width: 64px;'-->
					<?php
						$getlogo="select * from logo where flag='1' and nama != 'logo ck' order by nourut asc" ;
						$resgetlogo = mysql_query($getlogo);
						while($dtlogo = mysql_fetch_array($resgetlogo))
						{
							$url=$dtlogo['url'];
							echo "<img src='$url' style='width:33.33%;position:relative;display:inline-block;float:left'>";
						}
					?>
				</div>
			</header>
			...
			<div id='translt1'>
				...
				<font style='font-family: arial;font-size: 24px;color: <?php echo "#".$style;?>;font-weight: bold;'><?php echo $nmevent; ?><br><?php echo $sub; ?></font><br>
			...
			<div id='translt1' style='text-align: right;padding-top:15px;'>
				<!--h3 id="form_komen">Habitat Agenda<br> Partners Indonesia</h3-->
				<?php
					/*$getlogo="select * from logo where flag='1' and nama != 'logo ck' order by nourut asc" ;
					$resgetlogo = mysql_query($getlogo);
					...
					{
						$url=$dtlogo['url'];
						echo "<img src='$url' style='width:40%;position:relative;display:block;float:right;clear:both'>";
					}*/
				?>
			...
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" style='width: 100%;position: relative;float: left;left: 0px;'> 
				<div class="pkomentar input">
					<label for="direktorat" id="lbdirektorat">Nama:</label>
					<div>
				...
				<div class="pkomentar input">
					<label for="direktorat" id="lbdirektorat">Institusi / Organisasi:</label>
					<div>
				...
				<div class="pkomentar input">
					<label for="komentar" id="lblkomentar">Komentar / Tanggapan:</label>
					<div>
