        ...
        <div class="right col">
			...
			<table width="500" border="0">
              ...
              <tr>
                <td>Status</td>
                <td>:</td>
                <td><input type="radio" name="status" value="4" required>PKN<br>
					<input type="radio" name="status" value="1" required>Tidak Termasuk PKN<br></td>
              </tr>
              <tr>
                <td></td>
                <td></td>
			...
			<?php
					...
					$qinput = "INSERT INTO pkn (propinsi, kab_kota, pkn1,tahun) VALUES ('$propnew', '$kota', '$status','$tahun');";
					pg_query($qinput);
					...
					$charini = 	array("+");
					$propnew = str_replace($charini, " ",$propinsi);
					$qedit = "UPDATE pkn SET propinsi='$propnew', kab_kota='$kota', pkn1='$status',tahun='$tahun' WHERE pkn_pk='$id'";
					pg_query($qedit);
					echo "<div class=\"success\">";
					...
					$query = "select * from pkn where pkn_pk = '$id_delete'";
					...
					$sql2 = "DELETE FROM pkn where pkn_pk = '$id_delete'";
					pg_query($sql2);
				}else if(isset($_GET['id_edit'])){		//form edit data
					$id_edit = $_GET['id_edit'];
					$qedit = "select * from pkn where pkn_pk = '$id_edit'";
						...
						?>
							...
							<table width="500" border="0">
							  ...
							  <tr>
								...
								<td><?php
									if ($status == 4){
										echo '<input type="radio" name="status" value="4" required checked="checked">PKN<br>
											  <input type="radio" name="status" value="1" required>Tidak Termasuk PKN<br>';
									}else{
										echo '<input type="radio" name="status" value="4" required >PKN<br>
											  <input type="radio" name="status" value="1" required checked="checked">Tidak Termasuk PKN<br>';
									}
									?></td>
							  </tr>
							  <tr>
			...
			$sqlview = "SELECT * FROM pkn ORDER BY pkn_pk DESC";
			...
			if ($tcount == 0) {
				...
				echo "<tr >";
					...
					echo "<td>$status</td>";
					echo "<td align=\"center\"><a href=pkn.php?id_edit=$rowview[pkn_pk]>Edit</a> | <a href=\"pkn.php?id_delete=$rowview[pkn_pk]\" onclick='return confirmDelete();'>Delete</a></td>";
				echo "</tr>";
				$i++;
				$count++;
				}
