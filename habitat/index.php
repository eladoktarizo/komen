...
?>
	...
	<div class="question">
		<header>
			<div id="logo">
				<?php echo $logona;?> <img style="width: 10%; position: relative; float:right;" src="img/logock.png">
			</div>				
			<div id="logo2">
		...
		<div id='translt1'>
			...
			<font style='font-family: arial;font-size: 24px;color: #006699;font-weight: bold;'><?php echo $nmevent; ?><br><?php echo $sub; ?></font><br>
		...
		<div id='translt1' style='text-align: right;'>
			...
			<?php
				...
				{
					$url=$dtlogo['url'];
					echo "<img src='$url' style='width:65%;vertical-align: middle;'>";
				}
			?>
