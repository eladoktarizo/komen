        ...
        <div class="right col">
			...
			<table width="500" border="0">
              ...
              <tr>
                <td>Status</td>
                <td>:</td>
                <td><input type="radio" name="status" value="4" required>Sudah Memiliki Perda<br>
					<input type="radio" name="status" value="1" required>Belum Memiliki Perda<br></td>
              </tr>
              <tr>
                <td></td>
                <td></td>
			...
			<?php
					...
					$qinput = "INSERT INTO rtrw (propinsi, kab_kota, rtrw2,tahun) VALUES ('$propnew', '$kota', '$status','$tahun');";
					pg_query($qinput);
					...
					$charini = 	array("+");
					$propnew = str_replace($charini, " ",$propinsi);
					$qedit = "UPDATE rtrw SET propinsi='$propnew', kab_kota='$kota', rtrw2='$status' ,tahun='$tahun' WHERE rtrw_pk='$id'";
					pg_query($qedit);
					//echo $qedit;
					echo "<div class=\"success\">";
					...
					$query = "select * from rtrw where rtrw_pk = '$id_delete'";
					...
					$sql2 = "DELETE FROM rtrw where rtrw_pk = '$id_delete'";
					pg_query($sql2);
				}else if(isset($_GET['id_edit'])){		//form edit data
					$id_edit = $_GET['id_edit'];
					$qedit = "select * from rtrw where rtrw_pk = '$id_edit'";
			...
			$sqlview = "SELECT * FROM rtrw ORDER BY rtrw_pk DESC";
			...
			if ($tcount == 0) {
				...
				echo "<tr >";
					...
					echo "<td>$status</td>";
					echo "<td align=\"center\"><a href=rtrw.php?id_edit=$rowview[rtrw_pk]>Edit</a> | <a href=\"rtrw.php?id_delete=$rowview[rtrw_pk]\" onclick='return confirmDelete();'>Delete</a></td>";
				echo "</tr>";
				$i++;
				$count++;
				}
