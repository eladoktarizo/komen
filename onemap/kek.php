        ...
        <div class="right col">
			...
			<table width="500" border="0">
              ...
              <tr>
                <td>Status</td>
                <td>:</td>
                <td><input type="radio" name="status" value="4" required>KEK<br>
					<input type="radio" name="status" value="1" required>Bukan KEK<br>
				</td>
              </tr>
              <tr>
                <td></td>
			...
			<?php
					...
					$qinput = "INSERT INTO kek (propinsi, kab_kota, kek1,tahun) VALUES ('$propnew', '$kota', '$status','$tahun');";
					pg_query($qinput);
					...
					$charini = 	array("+");
					$propnew = str_replace($charini, " ",$propinsi);
					$qedit = "UPDATE kek SET propinsi='$propnew', kab_kota='$kota', kek1='$status',tahun='$tahun' WHERE kek_pk='$id'";
					pg_query($qedit);
					echo "<div class=\"success\">";
					...
					$query = "select * from kek where kek_pk = '$id_delete'";
					...
					$sql2 = "DELETE FROM kek where kek_pk = '$id_delete'";
					pg_query($sql2);
				}else if(isset($_GET['id_edit'])){		//form edit data
					$id_edit = $_GET['id_edit'];
					$qedit = "select * from kek where kek_pk = '$id_edit'";
						...
						?>
							...
							<table width="500" border="0">
							  ...
							  <tr>
								...
								<td><?php
									if ($status == 4){
										echo '<input type="radio" name="status" value="4" required checked="checked">KEK<br>
											  <input type="radio" name="status" value="1" required>Bukan KEK<br>';
									}else{
										echo '<input type="radio" name="status" value="4" required >KEK<br>
											  <input type="radio" name="status" value="1" required checked="checked">Bukan KEK<br>';
									}
									?>
								</td>
							  </tr>
			...
			$sqlview = "SELECT * FROM kek ORDER BY kek_pk DESC";
			...
			if ($tcount == 0) {
				...
				echo "<tr >";
					...
					echo "<td>$status</td>";
					echo "<td align=\"center\"><a href=kek.php?id_edit=$rowview[kek_pk]>Edit</a> | <a href=\"kek.php?id_delete=$rowview[kek_pk]\" onclick='return confirmDelete();'>Delete</a></td>";
				echo "</tr>";
				$i++;
				$count++;
				}
