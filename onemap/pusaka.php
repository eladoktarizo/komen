        ...
        <div class="right col">
			...
			<table width="500" border="0">
              ...
              <tr>
                <td>Status</td>
                <td>:</td>
                <td><input type="radio" name="status" value="4" required>Pusaka<br>
					<input type="radio" name="status" value="1" required>Bukan Pusaka<br></td>
              </tr>
              <tr>
                <td></td>
                <td></td>
			...
			<?php
					...
					$qinput = "INSERT INTO pusaka (propinsi, kab_kota, pusaka3,tahun) VALUES ('$propnew', '$kota', '$status','$tahun');";
					pg_query($qinput);
					...
					$charini = 	array("+");
					$propnew = str_replace($charini, " ",$propinsi);
					$qedit = "UPDATE pusaka SET propinsi='$propnew', kab_kota='$kota', pusaka3='$status',tahun='$tahun'  WHERE pusaka_pk='$id'";
					pg_query($qedit);
					//echo $qedit;
					echo "<div class=\"success\">";
					...
					$query = "select * from pusaka where pusaka_pk = '$id_delete'";
							...
							<table width="500" border="0">
							  ...
							  <tr>
								...
								<td>
									<?php
										if ($status == 4){
										echo '<input type="radio" name="status" value="4" required checked="checked">Pusaka<br>
											  <input type="radio" name="status" value="1" required>Bukan Pusaka<br>';
									}else{
										echo '<input type="radio" name="status" value="4" required >Pusaka<br>
											  <input type="radio" name="status" value="1" required checked="checked">Bukan Pusaka<br>';
									}
									?>
								</td>
							  </tr>
			...
			$sqlview = "SELECT * FROM pusaka ORDER BY pusaka_pk DESC";
			...
			if ($tcount == 0) {
				...
				echo "<tr >";
					...
					echo "<td>$status</td>";
					echo "<td align=\"center\"><a href=pusaka.php?id_edit=$rowview[pusaka_pk]>Edit</a> | <a href=\"pusaka.php?id_delete=$rowview[pusaka_pk]\" onclick='return confirmDelete();'>Delete</a></td>";
				echo "</tr>";
				$i++;
				$count++;
				}
