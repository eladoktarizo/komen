...
<?php
					...
					//	$res = mysql_query($update);
						...
						echo "<li><i class='icon-comment-alt'></i>&nbsp;<font color='#5182CC'>$nama  - $direktorat </font><p style='margin-left:20px;'>$komentar</p></li>";
						$update = "update pertanyaan set vote='2' where id='$id'";
						$res = mysql_query($update);
