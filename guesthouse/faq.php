...
background: #000;margin-bottom: 5px;">
		 <p style=" font-family:channels;letter-spacing: 1px;color:#000;"><b >FREQUENTLY ASKED</b> QUESTION</p>
	...
	<!-- slider close -->
			...
			<div class="row">
				...
				<br>
				<div class='span12'>
				<div id='sub1' ><p id='judulna'>THE FAMOUS 8. <BR>DISCOVER.</p></div>
...
<br>
				...
				<div id='sub3' style='width:75%;'><P style="font-family: futura;font-size: 16px;color: #5A5A5A;letter-spacing: 1px;margin-top: 3%;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse vestibulum tincidunt ante mollis ornare. Nulla id
